	subroutine sasgen(natom,atcrd,atrad,prad,scale,npoint,lunit,ngird)
c-----------------------------------------------------------
	implicit none
	integer natom,nsph
	parameter (nsph=600)
...
c
	...
	print *,'# of zero radius atoms to skip: ',nhatm
c
...
c	    write(lunit,223)(sphcrd(k,n),k=1,3),point
	...
	print *,'# of sphere points, coarsest spacing (grids),slabs : ',nspt,radmax*dz,nslab
