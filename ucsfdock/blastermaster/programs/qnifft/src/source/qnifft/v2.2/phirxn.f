	subroutine phirxn(ianal,epsin,epsout,natom,epkt,rtemp,frcfil,fasteps)
c 
...
c
	...
	write(6,*)' Interaction of rxn potl. and target q (kT) ',ergs
	write(42,*)' Interaction of rxn potl. and target q (kT) ',ergs
