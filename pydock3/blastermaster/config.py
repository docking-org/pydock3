...
#
BLASTERMASTER_CONFIG_SCHEMA_FILE_PATH = os.path.join(
    os.path.dirname(BLASTERMASTER_INIT_FILE_PATH), "blastermaster_config_schema.yaml"
)
...
class BlastermasterParametersConfiguration(ParametersConfiguration):
    def __init__(self, config_file_path):
        super().__init__(
            ...
            schema_file_path=BLASTERMASTER_CONFIG_SCHEMA_FILE_PATH,
        )
