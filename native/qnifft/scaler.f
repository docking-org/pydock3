...
9000	continue
	...
	character*30 ascl,axcen,aycen,azcen !strings for output of scale&center
	logical icen
c--------------------------------------------------
c
...
c
	write(ascl,'(g30.15)')scale
	call elb(ascl,30)
	write(axcen,'(g30.15)')oldmid(1)
	call elb(axcen,30)
	write(aycen,'(g30.15)')oldmid(2)
	call elb(aycen,30)
	write(azcen,'(g30.15)')oldmid(3)
	call elb(azcen,30)
	write(6,*)'scale=',ascl
	write(6,*)'xcen=',axcen
        write(6,*)'ycen=',aycen
